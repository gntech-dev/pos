...
async function getTopCustomers() {
  ...
  return withTotals
    ...
    .sort((a: { id: string; name: string; totalSales: number; totalRevenue: number }, b: { id: string; name: string; totalSales: number; totalRevenue: number }) => b.totalRevenue - a.totalRevenue)
    .slice(0, 20)
}